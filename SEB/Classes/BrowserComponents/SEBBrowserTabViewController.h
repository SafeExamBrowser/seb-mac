...
- (SEBAbstractWebView *) openNewTabWithURL:(NSURL *)url configuration:(WKWebViewConfiguration *)configuration overrideSpellCheck:(BOOL)overrideSpellCheck;
- (SEBAbstractWebView *) openNewTabWithURL:(NSURL *)url configuration:(WKWebViewConfiguration *)configuration index:(NSUInteger)index overrideSpellCheck:(BOOL)overrideSpellCheck;
- (SEBAbstractWebView *) openNewTabWithURL:(NSURL *)url configuration:(WKWebViewConfiguration *)configuration image:(UIImage *)templateImage;
