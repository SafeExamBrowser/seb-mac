...
SWIFT_CLASS("_TtC15VectorPencilKit21DrawingViewController")
@interface DrawingViewController : UIViewController
- (void)loadView;
- (void)viewWillAppear:(BOOL)animated;
- (void)didMoveToParentViewController:(UIViewController * _Nullable)parent;
- (void)setBackgroundImage:(UIImage * _Nonnull)image;
...
@interface UIDevice (SWIFT_EXTENSION(VectorPencilKit))
@property (nonatomic, readonly, copy) NSString * _Nonnull modelName;
@end

@class UIColor;

@interface UIImage (SWIFT_EXTENSION(VectorPencilKit))
...
SWIFT_CLASS("_TtC15VectorPencilKit17VEPViewController")
@interface VEPViewController : UIViewController <UIScrollViewDelegate>
