...
- (NSString*) customSEBUserAgent
{
    if (!_customSEBUserAgent) {
        ...
        overrideUserAgent = [overrideUserAgent stringByAppendingString:[NSString stringWithFormat:@" %@/%@ %@/3.2.5 %@/3.3 %@/3.3.2 %@/3.3.3 %@/3.4 %@", SEBUserAgentDefaultSuffix, versionString, SEBUserAgentDefaultSuffix, SEBUserAgentDefaultSuffix, SEBUserAgentDefaultSuffix, SEBUserAgentDefaultSuffix, SEBUserAgentDefaultSuffix, browserUserAgentSuffix]];
