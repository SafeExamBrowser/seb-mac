...
template<> EventTarget::ListenerOptions convertDictionary<EventTarget::ListenerOptions>(JSC::JSGlobalObject&, JSC::JSValue);

template<> EventTarget::AddEventListenerOptions convertDictionary<EventTarget::AddEventListenerOptions>(JSC::JSGlobalObject&, JSC::JSValue);
