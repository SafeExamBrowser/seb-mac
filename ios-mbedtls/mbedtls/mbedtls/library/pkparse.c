...
// dmcd - hack
#define ASN1_PUB_KEY_COPY_LEN 4096
static unsigned char asn1LastPublicKeyBlock[ASN1_PUB_KEY_COPY_LEN + 2];

void mbedtls_x509_private_seb_obtainLastPublicKeyASN1Block(unsigned char **block, unsigned int *len)
{
    *block = asn1LastPublicKeyBlock;
    *len = asn1LastPublicKeyBlock[0] << 8 | asn1LastPublicKeyBlock[1];
}
                        ...
                        mbedtls_pk_context *pk )
{
    ...
    /////////////////////////
    // dmcd - copy last encountered public key ASN1 block
    int copyLen = ASN1_PUB_KEY_COPY_LEN;
    ...
    asn1LastPublicKeyBlock[0] = (copyLen >> 8) & 0xff;
    asn1LastPublicKeyBlock[1] = copyLen & 0xff;
    memcpy(&asn1LastPublicKeyBlock[2], *p, copyLen);
    /////////////////////////
