...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/JitsiMeetSDK/Frameworks/JitsiMeetSDK.xcframework" "" "true" "ios-arm64/JitsiMeetSDK.framework" "ios-x86_64-simulator/JitsiMeetSDK.framework"
  install_xcframework "${PODS_ROOT}/JitsiMeetSDK/Frameworks/WebRTC.xcframework" "" "true" "ios-arm64/WebRTC.framework" "ios-x86_64-simulator/WebRTC.framework"
fi
